...
common=(
	CONFIG_64BIT CONFIG_SMP CONFIG_HOTPLUG_CPU
...
case "${platform}" in
	x86)
		required=(CONFIG_X86_64 CONFIG_RELOCATABLE CONFIG_PCI CONFIG_X86_MCE CONFIG_SERIAL_8250 CONFIG_SERIAL_8250_CONSOLE)
		;;
	riscv)
		required=(CONFIG_RISCV CONFIG_MMU CONFIG_RISCV_SBI CONFIG_RELOCATABLE CONFIG_FPU CONFIG_RISCV_ISA_V CONFIG_RISCV_ISA_V_DEFAULT_ENABLE CONFIG_SERIAL_8250 CONFIG_SERIAL_8250_CONSOLE)
		;;
